...
public class Maze implements Serializable
{
	...
	public Maze(Maze in) 
	{	
		buildAnimationDelay=in.buildAnimationDelay;
		solveAnimationDelay = in.solveAnimationDelay;
		mazeArray = in.mazeArray;
		currentArrayRow = 1;
		currentArrayCol= 1;
		alreadyBuilt=true;
		goalArrayRow=in.goalArrayRow;
		goalArrayCol=in.goalArrayCol;		
	}
